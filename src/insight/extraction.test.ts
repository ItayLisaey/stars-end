import { parseXMLExtractionResponse } from "./extract.js";
...
<errors>[]</errors>
    ...
    expect(() => parseXMLExtractionResponse(xml)).toThrow("Missing required field: data-json");
  });
...
{invalid json}
    ...
    expect(() => parseXMLExtractionResponse(xml)).toThrow("Failed to parse data-json");
  });
